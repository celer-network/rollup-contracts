...
contract RollupChain {
    ...
    function proveTransitionInvalid(
        ...
        require(
            _transitionStorageSlots[0].storageSlot.slotIndex ==
                storageSlotIndexes[0],
            "First supplied storage slot index is incorrect!"
        );
        require(
            _transitionStorageSlots[1].storageSlot.slotIndex ==
                storageSlotIndexes[1],
            "Second supplied storage slot index is incorrect!"
        );
    ...
    function registerAccount(
        address _account,
        address _initialDepositTokenAddress,
